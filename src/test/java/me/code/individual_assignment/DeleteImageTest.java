...
/**
 * The DeleteImageTest class contains integration tests for image deletion.
 */
@SpringBootTest
...
public class DeleteImageTest {
    ...
    /**
     * Tests deletion of an image using the {@link ImageService}.
     * Verifies that the image is deleted from the repository.
     */
    @Test
    @Transactional
